...
//   final _events =
//       StreamController<CallSocketEvent>.broadcast();
...
//     if (_conversationId <= 0 || _closedByUser) {
//       return;
//     }
...
//       query[tokenQueryKey] = token.trim();
